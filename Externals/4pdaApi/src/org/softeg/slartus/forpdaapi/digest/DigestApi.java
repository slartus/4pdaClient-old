...
public class DigestApi {
    ...
    public static class Apps {
        ...
        public static ArrayList<DigestCatalog> getCatalog(IHttpClient client, DigestCatalog parent) throws IOException {
            ...
            String body = client.performGetWithCheckLogin("http://4pda.ru/forum/index.php?showtopic=" + APP_DIGEST_ID + "&view=getlastpost",null,null);
    ...
    public static class Games {
        ...
        public static ArrayList<Topic> loadTopics(IHttpClient client, DigestCatalog catalog) throws IOException {
            String body = client.performGetWithCheckLogin("http://4pda.ru/forum/index.php?showtopic=" + GAME_DIGEST_ID + "&view=getlastpost",null,null);
