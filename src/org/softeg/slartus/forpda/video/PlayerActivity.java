package org.softeg.slartus.forpda.video;
...
import org.softeg.slartus.forpda.video.api.ParseResult;
import org.softeg.slartus.forpda.video.api.VideoFormat;
import org.softeg.slartus.forpda.video.api.YouTubeAPI;
import org.softeg.slartus.forpda.video.api.exceptions.ApiException;
import org.softeg.slartus.forpda.video.api.exceptions.IdException;
import org.softeg.slartus.forpda.video.api.exceptions.ListIdException;
...
public class PlayerActivity extends BaseFragmentActivity {
    ...
    public static void showYoutubeChoiceDialog(final Activity activity, final CharSequence youtubeUrl) {
        ...
        CharSequence[] items = {activity.getString(R.string.client_player), activity.getString(R.string.system_player)};
        final int[] selected_player = {0};
        new AlertDialogBuilder(activity)
                .setTitle("Выберите проигрыватель")
                .setAdapterSingleChoiceItems(items, selected_player[0], new DialogInterface.OnClickListener() {
                    @Override
            ...
            if (mEx != null) {
                if (mEx.getClass() == ApiException.class ||
                    ...
                    if (!tryPlayInYoutubePlayer())
                        org.softeg.slartus.forpda.common.Log.e(getContext(), mEx);
